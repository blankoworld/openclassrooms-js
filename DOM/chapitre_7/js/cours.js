...
// NOTE: Bloc commenté puisque le CSS fait la même chose avec les attributs animation
...
//     if (xBloc + largeurBloc + 2 <= xMax) { // Si le bloc n'est pas encore au bout du cadre
//         // Déplacement du bloc
